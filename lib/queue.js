...
const help = require('./help_text');

const store = {
  'af-prod': undefined,
  'af-staging': undefined,
  'al-prod': undefined,
  'al-staging': undefined,
  'api-prod': undefined,
  'api-staging': undefined,
  'ftp-prod': undefined,
  'ftp-staging': undefined,
  'impd-prod': undefined,
  ...
  'whoosh2-prod': undefined,
  'whoosh2-staging': undefined,
  'whoosh3-prod': undefined,
  'whoosh3-staging': undefined
};
...
function claim (resource, username) {
  ...
  if (typeof res !== 'string') {
    ...
    return `${prettyResource} is yours, X. Don't forget to release it with \`/snag release ${resource}\` when you're finished.`;
  }
  return res;
}
